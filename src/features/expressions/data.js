// ════════════════════════════════════════════════════════════════════════════
// 表情資料表 —— 由 WCE src/util/expressions.ts 機械式轉換而來（只去除 TS 型別註記，
// 資料內容完全未改，以免手動重打 500+ 行時出錯）。
//
//   ArousalExpressionStages 慾望值 → 各部位表情的分級門檻
//   EventExpressions        具名事件 → 表情動畫（高潮後、活動反應等）
//   ActivityTriggers        聊天訊息/活動 → 對應到哪個事件（正則比對）
// ════════════════════════════════════════════════════════════════════════════

export const ArousalExpressionStages = {
  Blush: [
